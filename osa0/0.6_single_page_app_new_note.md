...
Note right of browser: Then the code creates a new note and adds it to the notes list and calls a function that makes that sends the information to server.
